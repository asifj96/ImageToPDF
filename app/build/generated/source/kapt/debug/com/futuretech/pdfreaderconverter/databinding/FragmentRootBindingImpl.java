...
public class FragmentRootBindingImpl extends FragmentRootBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.mCvNativeAd, 3);
        sViewsWithIds.put(R.id.adViewNoPermission_one, 4);
        sViewsWithIds.put(R.id.rvRootItemList, 5);
    }
    // views
    @NonNull
    ...
    public FragmentRootBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }
    private FragmentRootBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            , (android.widget.FrameLayout) bindings[4]
            , (androidx.cardview.widget.CardView) bindings[3]
            , (androidx.recyclerview.widget.RecyclerView) bindings[5]
            , (com.facebook.shimmer.ShimmerFrameLayout) bindings[1]
            , (com.futuretech.pdfreaderconverter.databinding.LayoutMainToolbarBinding) bindings[2]
            );
        this.mboundView0 = (androidx.constraintlayout.widget.ConstraintLayout) bindings[0];
        this.mboundView0.setTag(null);
        this.shimmerLayoutNative.setTag(null);
