...
public class ActivityEditImageScreenBindingImpl extends ActivityEditImageScreenBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.cLDone, 14);
        sViewsWithIds.put(R.id.iVDone, 15);
    ...
    public ActivityEditImageScreenBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 17, sIncludes, sViewsWithIds));
    }
    private ActivityEditImageScreenBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
